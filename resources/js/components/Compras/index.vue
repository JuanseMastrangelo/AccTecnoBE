<template>
    <div>
        ...
        <div class="mx-auto col-11">
            <div class="col-12 custom-border-bottom rounded-top p-1 d-flex align-items-center" style="background: var(--primary);">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{elSelected && elSelected.idBuy}}</h5>
                        <button type="button" v-on:click="elSelected = null" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" v-if="elSelected">
